      ...
      <div className="flex flex-wrap gap-4">
        {filterTags.map((tag, index) => (
          <div key={index} className="bg-darkCyan/10 rounded-[5px] inline-flex">
            ...
            <div
              className="bg-darkCyan w-8 h-8 rounded-r-[5px] grid place-content-center hover:bg-veryDarkGrayishCyan cursor-pointer transition-colors duration-200 ease-in"
              onClick={() => {
